...
import os
import colorsys
from nets.slowfastnet_frame import slowfastnet as Network
...
class MAP_vid(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : '/home/dww/OD/two_stream0/logs/loss_2024_05_13_12_06_20/best_epoch_weights.pth', 
    ...
    def generate(self, onnx=False):
        self.net    = Network(self.num_classes, num_frame=8) #frames
...
def get_history_imgs(line):
    ...
    return [os.path.join(dir_path,  "%d.%s" % (max(id, 0),file_type)) for id in range(index - 7, index + 1)] #frame
...
if __name__ == "__main__":
    ...
    if map_mode == 0 or map_mode == 1:
        ...
        with open(os.path.join(temp_save_path, 'eval_results.json'),"w") as f:
            ...
            for image_id in tqdm(ids):
                ...
                images = get_history_imgs(image_path) # frames
    ...
    if map_mode == 0 or map_mode == 2:
        ...
        print("Get map done.")
        # with open("DAUB_result.txt", 'w') as f:
